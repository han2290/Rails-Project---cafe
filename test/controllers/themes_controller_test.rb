...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { contents: @theme.contents, text: @theme.text, title: @theme.title } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { contents: @theme.contents, text: @theme.text, title: @theme.title } }
